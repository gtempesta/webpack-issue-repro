...
const config = {
    ...
    plugins: [
        ...
        new WebpackNotifierPlugin({ title: 'Modern JS Webpack', excludeWarnings: true, alwaysNotify: true }),
        new ModuleFederationPlugin({
            name: 'host',
            library: { type: 'module' },
            filename: 'remoteEntry.js',
            remotes: {
                remote_bucket: 'https://mda.orion.pixartprinting.net/design-area/review/master/assets/remoteEntry.js',
            },
        }),
    ],
    output: {
